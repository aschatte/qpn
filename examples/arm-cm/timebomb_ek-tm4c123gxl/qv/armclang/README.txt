...
Project Build:
==============
The build should complete with 0 Error(s), 3 Warning(s).  The
warnings should document the PARAM_SIZE specification as follows:

TimeBomb/main_qpm.c(27): warning: ----------------   Build Configuration   ---------------- [-W#warnings]
#warning ----------------   Build Configuration   ----------------
 ^
TimeBomb/main_qpm.c(29): warning: PARAM_SIZE=0: [-W#warnings]
    #warning PARAM_SIZE=0:
     ^
TimeBomb/main_qpm.c(37): warning: ----------------   Build Configuration   ---------------- [-W#warnings]
#warning ----------------   Build Configuration   ----------------
 ^
