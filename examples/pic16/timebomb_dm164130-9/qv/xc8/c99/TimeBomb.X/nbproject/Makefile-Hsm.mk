...
ifeq "$(wildcard nbproject/Makefile-local-Hsm.mk)" "nbproject/Makefile-local-Hsm.mk"
include nbproject/Makefile-local-Hsm.mk
endif
endif
...
SOURCEFILES_QUOTED_IF_SPACED=../../../../DM164130-9/bsp.c ../../../../../../../src/qfn/Hsm.c ../../../../../../../src/qfn/qfn.c ../../../../../../../src/qvn/qvn.c ../../../../main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1487629836/bsp.p1 ${OBJECTDIR}/_ext/2105057759/Hsm.p1 ${OBJECTDIR}/_ext/2105057759/qfn.p1 ${OBJECTDIR}/_ext/2105058255/qvn.p1 ${OBJECTDIR}/_ext/1568745167/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1487629836/bsp.p1.d ${OBJECTDIR}/_ext/2105057759/Hsm.p1.d ${OBJECTDIR}/_ext/2105057759/qfn.p1.d ${OBJECTDIR}/_ext/2105058255/qvn.p1.d ${OBJECTDIR}/_ext/1568745167/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1487629836/bsp.p1 ${OBJECTDIR}/_ext/2105057759/Hsm.p1 ${OBJECTDIR}/_ext/2105057759/qfn.p1 ${OBJECTDIR}/_ext/2105058255/qvn.p1 ${OBJECTDIR}/_ext/1568745167/main.p1

# Source Files
SOURCEFILES=../../../../DM164130-9/bsp.c ../../../../../../../src/qfn/Hsm.c ../../../../../../../src/qfn/qfn.c ../../../../../../../src/qvn/qvn.c ../../../../main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Hsm.mk dist/${CND_CONF}/${IMAGE_TYPE}/TimeBomb.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/2105057759/Hsm.p1: ../../../../../../../src/qfn/Hsm.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/_ext/2105057759" 
	@${RM} ${OBJECTDIR}/_ext/2105057759/Hsm.p1.d 
	@${RM} ${OBJECTDIR}/_ext/2105057759/Hsm.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -DDM164130_9 -xassembler-with-cpp -I"../../../../" -I"../../../../DM164130-9" -I"../../../../../../../include" -mwarn=-3 -Wa,-a -DXPRJ_Hsm=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/_ext/2105057759/Hsm.p1 ../../../../../../../src/qfn/Hsm.c 
	@-${MV} ${OBJECTDIR}/_ext/2105057759/Hsm.d ${OBJECTDIR}/_ext/2105057759/Hsm.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/2105057759/Hsm.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/TimeBomb.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/TimeBomb.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_Hsm=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -DDM164130_9 -xassembler-with-cpp -I"../../../../" -I"../../../../DM164130-9" -I"../../../../../../../include" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/TimeBomb.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/TimeBomb.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/TimeBomb.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/TimeBomb.X.${IMAGE_TYPE}.map  -DXPRJ_Hsm=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -DDM164130_9 -xassembler-with-cpp -I"../../../../" -I"../../../../DM164130-9" -I"../../../../../../../include" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/TimeBomb.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
